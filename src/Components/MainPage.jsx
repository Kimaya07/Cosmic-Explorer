  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-blue-950 to-purple-950 flex flex-col items-center justify-center">
        ...
        <p className="text-purple-300 mt-4 font-light">Connecting to deep space...</p>
      </div>
    );
  }
    ...
    >
      ...
      <div className="max-w-3xl mx-auto pt-8 relative z-10">
          ...
          {facts.map((_, index) => (
            <div 
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                index === currentIndex ? 'bg-purple-400 scale-125' : 'bg-gray-600'
              }`}
            />
          ))}
        </div>
        ...
        <div className="mt-12 flex justify-center opacity-50">
          <div className="relative">
            <Star size={10} className="text-white absolute" style={{ top: '0px', left: '30px' }} />
            <Star size={8} className="text-white absolute" style={{ top: '15px', left: '10px' }} />
            <Star size={12} className="text-white absolute" style={{ top: '20px', left: '50px' }} />
            <Star size={9} className="text-white absolute" style={{ top: '5px', left: '70px' }} />
            <svg width="100" height="30" xmlns="http://www.w3.org/2000/svg">
              <line x1="10" y1="15" x2="30" y2="0" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
              <line x1="30" y1="0" x2="50" y2="20" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
              <line x1="50" y1="20" x2="70" y2="5" stroke="rgba(255,255,255,0.3)" strokeWidth="0.5" />
            </svg>
          </div>
        </div>
        {/* Back button */}
